        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarryForwardDays = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AvailableDays = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[TotalDays] - [UsedDays] - [PendingDays]", stored: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveBalances", x => x.Id);
                    table.CheckConstraint("CK_LeaveBalances_AvailableDays", "[TotalDays] - [UsedDays] - [PendingDays] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LeaveRequestId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LeaveTypeId = table.Column<int>(type: "int", nullable: false),
                    ...
                    CurrentWorkflowState = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    WorkflowProcessId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    WorkflowSchemeCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproverId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveApprovals_ActionDate",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_LeaveBalances_UserTypeYear",
                table: "LeaveBalances",
                columns: new[] { "UserId", "LeaveTypeId", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_Dates",
                table: "LeaveRequests",
                columns: new[] { "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_LeaveRequestId",
                table: "LeaveRequests",
                column: "LeaveRequestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_WorkflowProcessId",
                table: "LeaveRequests",
